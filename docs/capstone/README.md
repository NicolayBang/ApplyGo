...
4. Read `m1-manual-demo-validation-2026-06-14.md` for the latest recorded validation evidence.
5. Use `process.md` to understand the project discipline behind the work.
6. Treat `phase-2-ideas.md` as future discussion material only.
